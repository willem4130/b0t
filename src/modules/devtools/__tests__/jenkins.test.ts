...
describe('jenkins module', () => {
  ...
  describe('apiFunction', () => {
    it('should call API successfully', async () => {
      const result = await jenkins.apiFunction({ param: 'value' });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(jenkins.apiFunction({}))
