...
describe('circleci module', () => {
  ...
  describe('apiFunction', () => {
    it('should call API successfully', async () => {
      const result = await circleci.apiFunction({ param: 'value' });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(circleci.apiFunction({}))
