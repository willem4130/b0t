...
/**
 * Tests for communication/zendesk
 *
...
describe('zendesk module', () => {
  ...
  describe('apiFunction', () => {
    it('should call API successfully', async () => {
      const result = await zendesk.apiFunction({ param: 'value' });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(zendesk.apiFunction({}))
