...
/**
 * Tests for communication/intercom
 *
...
describe('intercom module', () => {
  ...
  describe('apiFunction', () => {
    it('should call API successfully', async () => {
      const result = await intercom.apiFunction({ param: 'value' });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(intercom.apiFunction({}))
