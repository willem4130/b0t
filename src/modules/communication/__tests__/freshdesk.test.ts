...
/**
 * Tests for communication/freshdesk
 *
...
describe('freshdesk module', () => {
  ...
  describe('apiFunction', () => {
    it('should call API successfully', async () => {
      const result = await freshdesk.apiFunction({ param: 'value' });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(freshdesk.apiFunction({}))
