...
/**
 * Tests for communication/onesignal
 *
...
describe('onesignal module', () => {
  ...
  describe('apiFunction', () => {
    it('should call API successfully', async () => {
      const result = await onesignal.apiFunction({ param: 'value' });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(onesignal.apiFunction({}))
