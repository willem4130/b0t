...
import * as phantombuster from '../phantombuster';

/**
 * Tests for leads/phantombuster
 *
...
describe('phantombuster module', () => {
  ...
  it('should export functions', () => {
    expect(phantombuster).toBeDefined();
  });
  ...
  describe('apiFunction', () => {
    it('should call API successfully', async () => {
      const result = await phantombuster.apiFunction({ param: 'value' });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(phantombuster.apiFunction({}))
    ...
    it('should pass correct parameters to API', async () => {
      ...
      await phantombuster.apiFunction({
        param1: 'value1',
        param2: 'value2'
      });
