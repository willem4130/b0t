...
import * as zoominfo from '../zoominfo';

/**
 * Tests for leads/zoominfo
 *
...
describe('zoominfo module', () => {
  ...
  describe('apiFunction', () => {
    it('should call API successfully', async () => {
      const result = await zoominfo.apiFunction({ param: 'value' });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(zoominfo.apiFunction({}))
