...
describe('ai-sdk module', () => {
  ...
  describe('apiFunction', () => {
    it('should call API successfully', async () => {
      const result = await ai_sdk.apiFunction({ param: 'value' });
    ...
    it('should handle API errors', async () => {
      ...
      await expect(ai_sdk.apiFunction({}))
